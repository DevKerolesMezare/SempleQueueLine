...
{
    public partial class ctrlFilterTicketsByQueueName : UserControl
    {
        public ctrlFilterTicketsByQueueName()
        {
            InitializeComponent();
        }
        ...
        {
            ctrlServeTicket1.StepCompleted += (s, e) =>
            {
        ...
        void RenderTickets(List<string> tickets)  // %80 Chat GPT
        {
        ...
        {
            frmQueueInfo frm = new frmQueueInfo();
            frm.Show();
        }
        ...
        private void tableLayoutPanel1_Click(object sender, EventArgs e)
        {
            ...
            if (clickedLabel != null)
            {
                ...
                frmTicketDetails frm = new frmTicketDetails(clickedLabel.Text);
                frm.ShowDialog();
            }
        }
    }
